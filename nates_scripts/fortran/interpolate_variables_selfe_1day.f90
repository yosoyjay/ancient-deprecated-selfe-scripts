...
!********************************************************************************
!										
!	Interpolate 2 or 3D variables from SELFE results (format v5.0) to get *3D.th.		
...
!       Output: *3D.th format: ifile=1, fort.16 (elev); ifile=2, fort.17 and fort.18 (T,S); 
!               ifile=3, fort.17 (uv).
!               fort.11: fatal errors.
!               Use timeint_3Dth.f90 to change time step in these outputs.
!									
!       ifort -Bstatic -O3 -assume byterecl -o interpolate_variables_selfe3 interpolate_variables_selfe3.f90
!********************************************************************************
!
      program interpolate
