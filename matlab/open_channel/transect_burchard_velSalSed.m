...
axisTrans = [0 40000 -15 3];
aTTicks   = 0:10000:40000;
aTLabel   = 0:10:40;
...
%	[hvelData varTs] = sz_readTimeStep(hHvel,steps);
%	[saltData varTs] = sz_readTimeStep(hSalt,steps);
%	[sedData varTs]  = sz_readTimeStep(hSed,steps);
