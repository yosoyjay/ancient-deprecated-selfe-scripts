...
% relshape = [46 13.8323 -124 9.7228];

relshape = [46 13.8323 -124 10.2229;
            46 13.3323 -124 9.7779;
            46 12.8323 -124 9.2279;
            46 15.3323 -124 10.7229;
            46 14.8323 -124 9.7779;
            46 14.3323 -124 9.2279];
...
reltime=[2008 9 25 13 00; 2008 9 25 14 00; 2008 9 25 15 00];
...
eval(['!ln -s /home/workspace/local0/forecasts/' modname '/' num2str(reltime(1,1)) '-' solday_p1 '/run/2_elev.61 3_elev.61'])
eval(['!ln -s /home/workspace/local0/forecasts/' modname '/' num2str(reltime(1,1)) '-' solday_p1 '/run/2_hvel.64 3_hvel.64'])
eval(['!ln -s /home/workspace/local0/forecasts/' modname '/' num2str(reltime(1,1)) '-' solday_p1 '/run/2_vert.63 2_vert.'])
...
% Plot the results
hpath = plotpath(plottype,relshape,figure_title);
sdat = hgexport('factorystyle');
hgexport(gcf,'ptrack_plot_temp.eps',sdat,'format','eps');
!rm *.gr3 *.ll fort.*
