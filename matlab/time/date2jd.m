...
%
%  NOTE!!!  This M-file has been altered so the julian day at 12:00 AM, January
%  first, 0000 is equal to 1.0 (see below).
%
...
%   URL:         http://home.online.no/~pjacklam
   ...
   jd = day + floor((153.*m + 2)./5) ...
        ...
        + ( second + 60.*minute + 3600.*(hour - 12) )./86400 - 1721059.5; % last term is adjustment (see above)!
