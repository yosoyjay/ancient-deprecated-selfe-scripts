...
C
C Altered to read input from tide_fac.in instead of cli interaction
C lopezj - 08/17/2012
      PARAMETER(NCNST=37)
      ...
      OPEN(UNIT=99,FILE='tide_fac.in',STATUS='OLD')

C      WRITE(*,*) 'ENTER LENGTH OF RUN TIME (DAYS)'
C      READ(*,*) XDAYS
      READ(99,*) XDAYS
      RHRS=XDAYS*24.

C      WRITE(*,*)' ENTER START TIME - BHR,IDAY,IMO,IYR (IYR e.g. 1992)'
C      READ(*,*) BHR,IDAY,IMO,IYR
      READ(99,*) BHR,IDAY,IMO,IYR
      YR=IYR
      MONTH=IMO
      DAY=IDAY
      HRM=BHR+RHRS/2.
